...
package org.puremvc.as3.core
{
	...
	public class View implements IView
	{
		...
		{
			var observers:Vector.<IObserver> = observerMap[ notificationName ];
			if( observers ) {
		...
		public function registerMediator( mediator:IMediator ) : void
		{
			...
			var interests:Vector.<String> = mediator.listNotificationInterests();
		...
		protected var mediatorMap : Dictionary.<String, IMediator>;

		// Mapping of Notification names to Observer lists
		protected var observerMap : Dictionary.<String, Vector.<IObserver>>;
